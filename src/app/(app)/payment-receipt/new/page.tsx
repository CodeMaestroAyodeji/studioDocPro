...
export default function NewPaymentReceiptPage() {
  ...
  useEffect(() => {
    ...
    form.setValue('receiptNumber', nextReceiptNumber);
  }, [form]);

  const handleSubmit = (values: z.infer<typeof receiptSchema>) => {
    try {
      getNextReceiptNumber(true); // Increment and save
      ...
      toast({
        title: 'Receipt Saved',
        description: `Receipt ${values.receiptNumber} has been saved.`,
      });
      ...
      toast({
        ...
        description: 'Could not save the receipt to local storage.',
      });
    }
  };
    ...
    <div className="flex flex-1 flex-col">
      ...
      <main className="flex-1 p-4 sm:px-6 sm:py-0 space-y-4">
        <div className="flex justify-end sticky top-[57px] sm:top-0 z-10 py-2 bg-background no-print">
          <Button type="submit" form="receipt-form">Save Receipt</Button>
        </div>
        <Form {...form}>
            ...
            <DocumentPage>
              <header className="flex justify-between items-start mb-8">
                ...
                <div className="text-right">
                  ...
                  <p className="text-sm">No: <span className="font-semibold">{receiptNumber}</span></p>
                </div>
              </header>
